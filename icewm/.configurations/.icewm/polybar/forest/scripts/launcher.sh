...
FILE="$HOME/.icewm/polybar/forest/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.icewm/polybar/forest/scripts/rofi/launcher.rasi
