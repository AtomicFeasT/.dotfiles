...
FILE="$HOME/.icewm/polybar/blocks/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.icewm/polybar/blocks/scripts/rofi/launcher.rasi
